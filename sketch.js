...
diameter=40;
ball1=new Ball(width/3-diameter*2,height/4+150,diameter);
ball2=new Ball(width/3-diameter*1,height/4+150,diameter);
ball3=new Ball(width/3,height/4+150,diameter);
ball4=new Ball(width/3+diameter*1,height/4+150,diameter);
ball5=new Ball(width/3+diameter*2,height/4+150,diameter);
